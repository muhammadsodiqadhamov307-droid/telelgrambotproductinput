...
export const transcribeAndParse = async (audioPath: string): Promise<ProductDraft[]> => {
    ...
    **Inference Rules (How to understand the user):**
    ...
    2. **Identify the Car Model**: Words like "Spark", "Cobalt", "Gentra", "Nexia", "Malibu", "Best", "Sons" are almost ALWAYS the **Category**.
       - **SPECIAL RULE**: "Best" and "Sons" are valid Car unique to us. If user says "Best" or "Sons", the Car Model is "Best" or "Sons".
